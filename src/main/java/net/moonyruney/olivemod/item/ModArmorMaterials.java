...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    TROLLIUM("trollium", 22, new int[]{3, 5, 7, 3}, 35,
            SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1.0f, 1.0f, () -> Ingredient.ofItems(ModItems.TROLLIUM_INGOT)),
    DECEIUM("deceium", 30, new int[]{3, 6, 8, 3}, 14,
    SoundEvents.ITEM_ARMOR_EQUIP_IRON, 5.0f, 0.0f, () -> Ingredient.ofItems(ModItems.DECEIUM_INGOT));
